...
--
-- Host: localhost    Database: leobot
-- ------------------------------------------------------
...
INSERT INTO `categories` VALUES (1,NULL,'Excerpt','Short snippet of a good teaching/ book',_binary '\0'),(2,NULL,'Testimony','Personal Experience of God\'s goodness',_binary '\0');
...
INSERT INTO `functions` VALUES (1,'help','find out what are the functions you can access now',1,_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary '',_binary '\0'),(2,'start','starts a conversation with the bot',1,_binary '',_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary '\0'),(3,'cancel','cancels currently using job or function',1,_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary '\0',_binary ''),(4,'end','ends the conversation menu',1,_binary '\0',_binary '',_binary '',_binary '',_binary '\0',_binary ''),(5,'quit','quits all menus and returns to start menu',1,_binary '\0',_binary '\0',_binary '',_binary '',_binary '\0',_binary ''),(6,'admin_menu','enters the admin menu (only for people with admin perms)',3,_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0',_binary '\0'),(7,'new_thread','write a new thread to be posted in the group!',1,_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0',_binary '\0'),(8,'feedback','write a feedback to the admins',1,_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0',_binary '\0'),(9,'sview_fb','Feedback Summary View',1,_binary '\0',_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0'),(10,'dview_fb','<feedback id> Feedback Detailed View',1,_binary '\0',_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0'),(11,'ch_perm','/ch_perm <user> <perms> to change the permissions of another user',3,_binary '\0',_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0'),(12,'del_threads','/del_threads <thread number> for any number of values to delete the threads. There is no confirmation messgae so please by sure before deleting',3,_binary '\0',_binary '\0',_binary '',_binary '\0',_binary '\0',_binary '\0');
...
-- Dump completed on 2021-01-03 19:20:18
